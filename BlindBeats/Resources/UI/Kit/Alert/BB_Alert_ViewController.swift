...
public class BB_Alert_ViewController : UIViewController {
	...
	@discardableResult public static func present(_ error:Error, _ handler:(()->Void)? = nil) -> BB_Alert_ViewController {
		
		let viewController:BB_Alert_ViewController = .init()
	...
	public static func presentLoading(_ completion:((BB_Alert_ViewController?)->Void)? = nil) {
	...
	@discardableResult public func add(_ string:String?) -> BB_Label {
		
		let label:BB_Label = .init(string)
	...
	@discardableResult public func addButton(sticky:Bool = false, title:String, subtitle:String? = nil,image:UIImage? = nil, _ handler:BB_Button.Handler = nil) -> BB_Button {
		
		let button:BB_Button = .init(title,handler)
	...
	@discardableResult public func addCancelButton(sticky:Bool = false, _ handler:BB_Button.Handler = nil) -> BB_Button {
		
		let button:BB_Button = addButton(sticky:sticky, title: String(key: "alert.cancel.button")) { [weak self] button in
	...
	@discardableResult public func addDismissButton(sticky:Bool = false, _ handler:BB_Button.Handler = nil) -> BB_Button {
		
		let button:BB_Button = addButton(sticky:sticky, title: String(key: "alert.dismiss.button")) { [weak self] button in
...
extension BB_Alert_ViewController : UIScrollViewDelegate {
...
extension BB_Alert_ViewController : UIPopoverPresentationControllerDelegate {
