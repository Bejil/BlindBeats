...
public class BB_Placeholder_View: UIView {
	...
	private lazy var scrollView:BB_ScrollView = {
	...
	convenience init(_ style:Style? = nil, _ error:Error? = nil, _ handler:BB_Button.Handler = nil) {
	...
	@discardableResult public func addLabel(_ string:String) -> BB_Label {
	...
	@discardableResult public func addButton(_ string:String? = nil, _ handler:BB_Button.Handler = nil) -> BB_Button {
		
		let button:BB_Button = .init(string,handler)
