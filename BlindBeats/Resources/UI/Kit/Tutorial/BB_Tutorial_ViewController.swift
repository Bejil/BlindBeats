//
//  BB_Tutorial_ViewController.swift
//  BlindBeats
//
...
public class BB_Tutorial_ViewController: BB_ViewController {
	...
	public lazy var subtitleLabel: BB_Label = {
	...
	private lazy var nextButton: BB_Button = .init() { [weak self] _ in
