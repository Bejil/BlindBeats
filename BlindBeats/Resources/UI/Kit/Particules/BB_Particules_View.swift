...
public class BB_Particules_View : SKView {
	...
	public lazy var particulesEmitterNode:SKEmitterNode = {
		...
		$0.particleColor = UIColor.white.withAlphaComponent(0.35)
		return $0
		
	}(SKEmitterNode(fileNamed: "BB_Particules.sks")!)
