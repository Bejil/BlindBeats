...
public class BB_Button : UIButton {
	
	public enum BB_ButtonType {
		case primary
		case secondary
		case tertiary
		case navigation
	...
	// MARK: - Properties
	public var type: BB_ButtonType = .primary {
		didSet {
	...
	public var style: BB_ButtonStyle = .solid {
	...
	public typealias Handler = ((BB_Button?) -> Void)?
	...
	// MARK: - UI Components
	private lazy var badgeView: BB_Label = {
